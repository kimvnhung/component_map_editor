...
Window {
    ...
    GraphModel {
        ...
        Component.onCompleted: {
            ...
            var n1 = Qt.createQmlObject('import JobDesigner; NodeModel {}', graph)
            n1.id = "n1"; n1.label = "Start";   n1.x = 80;  n1.y = 220
            n1.color = "#26a69a"; n1.type = "start"
            graph.addNode(n1)

            var n2 = Qt.createQmlObject('import JobDesigner; NodeModel {}', graph)
            n2.id = "n2"; n2.label = "Process A"; n2.x = 280; n2.y = 140
            n2.color = "#5c6bc0"; n2.type = "process"
            graph.addNode(n2)

            var n3 = Qt.createQmlObject('import JobDesigner; NodeModel {}', graph)
            n3.id = "n3"; n3.label = "Process B"; n3.x = 280; n3.y = 300
            n3.color = "#5c6bc0"; n3.type = "process"
            graph.addNode(n3)

            var n4 = Qt.createQmlObject('import JobDesigner; NodeModel {}', graph)
            n4.id = "n4"; n4.label = "Decide";  n4.x = 480; n4.y = 220
            n4.color = "#ab47bc"; n4.type = "decision"
            graph.addNode(n4)

            var n5 = Qt.createQmlObject('import JobDesigner; NodeModel {}', graph)
            n5.id = "n5"; n5.label = "End";     n5.x = 680; n5.y = 220
            n5.color = "#ef5350"; n5.type = "end"
            graph.addNode(n5)

            // Seed some edges
            var e1 = Qt.createQmlObject('import JobDesigner; EdgeModel {}', graph)
            e1.id = "e1"; e1.sourceId = "n1"; e1.targetId = "n2"; e1.label = "path A"
            graph.addEdge(e1)

            var e2 = Qt.createQmlObject('import JobDesigner; EdgeModel {}', graph)
            e2.id = "e2"; e2.sourceId = "n1"; e2.targetId = "n3"; e2.label = "path B"
            graph.addEdge(e2)

            var e3 = Qt.createQmlObject('import JobDesigner; EdgeModel {}', graph)
            e3.id = "e3"; e3.sourceId = "n2"; e3.targetId = "n4"
            graph.addEdge(e3)

            var e4 = Qt.createQmlObject('import JobDesigner; EdgeModel {}', graph)
            e4.id = "e4"; e4.sourceId = "n3"; e4.targetId = "n4"
            graph.addEdge(e4)

            var e5 = Qt.createQmlObject('import JobDesigner; EdgeModel {}', graph)
