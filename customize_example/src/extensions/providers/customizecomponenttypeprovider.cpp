...
cme::templates::v1::ComponentTypeTemplateBundle buildTemplateBundle()
{
    ...
    *bundle.add_component_types() = makeType(
        CustomizeComponentTypeProvider::TypeStart, "Start", "control", 92.0, 92.0, "#66bb6a", false, true);
    *bundle.add_component_types() = makeType(
        CustomizeComponentTypeProvider::TypeCondition, "Condition", "control", 164.0, 100.0, "#ffca28", true, true);
    *bundle.add_component_types() = makeType(
        CustomizeComponentTypeProvider::TypeProcess, "Process", "work", 164.0, 100.0, "#4fc3f7", true, true);
    *bundle.add_component_types() = makeType(
        CustomizeComponentTypeProvider::TypeStop, "Stop", "control", 92.0, 92.0, "#ef5350", true, false);

    *bundle.add_defaults() = makeDefaults(CustomizeComponentTypeProvider::TypeStart,
