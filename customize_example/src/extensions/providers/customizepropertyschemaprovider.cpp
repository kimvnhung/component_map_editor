...
QStringList CustomizePropertySchemaProvider::schemaTargets() const
{
    return {
        ...
        QStringLiteral("component/condition"),
...
QVariantList CustomizePropertySchemaProvider::propertySchema(const QString &targetId) const
{
    ...
    if (targetId == QStringLiteral("component/condition")) {
        return {
            withSection(entry("title", "string", "Title", true, QString(), "textfield"),
                        "Identity", 1,
                        QStringLiteral("Human-friendly label shown on the graph.")),
            ...
            withSection(entry("color", "string", "Color", true, QStringLiteral("#ffca28"), "textfield"),
                        "Appearance", 31)
        };
    }
